...
enum EntityType   { PLAYER, BLOCK, PLATFORM, NPC, KEY, DOOR, BULLET };
...
private:
    ...
    Texture2D mHeart = LoadTexture("assets/heart.png");
...
public:
    ...
    void setAnimationAtlas(std::map<Direction, std::vector<int>> newMap){
        mAnimationAtlas = newMap;
    }
